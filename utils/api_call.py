    ...
    try:
        ...
        with requests.Session() as session:
            ...
            if response.status_code == 200:
                ...
                with open(f'../utils/amplitude_outputs/rqls/{actual_date}-amplitude_data.json', 'wb') as f:
...
def process_rql_data(actual_date):
    try:
        ...
        with open(f'../utils/amplitude_outputs/rqls/{actual_date}-amplitude_data.json', 'r', encoding='utf-8') as archivo:
